...
function join(stringOne, stringTwo) {
    ...
    var args = Array.from(arguments);
     ...
     // iterating through array of arguments
     for (let i = 0; i < args.length; i++) {
        // concatenating output and args
         output += args[i];
     }
...
O: return the longest of the two strings
C: N/A
E: N/A
*/
...
function longest(stringOne, stringTwo) {
    ...
    // if the length of stringOne is greater than stringTwo
    if (stringOne.length > stringTwo.length) {
        // returning stringOne
        return stringOne;
    } 
    // if the length of stringTwo is greater than stringOne
    if (stringOne.length < stringTwo.length) {
        // returning stringTwo
        return stringTwo;
    }
